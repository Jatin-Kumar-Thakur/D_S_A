//Create circular LL
//insert node at Start,End,Random position
//Delete node from Start,End,Random position
#include <iostream>
using namespace std;
...
void deleteFromRandomPosition(node *&head, node *&temp, node *&end, int pos)
{
...
int main(int argc, char const *argv[])
{
    ...
    cout << endl;
    deleteFromRandomPosition(head, temp, end, 3);
    display(head, temp);
    return 0;
}
